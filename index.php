	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  ...
			  <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true">Item Parts</a>

			  <a class="nav-link" id="v-pills-repair-tab" data-toggle="pill" href="#v-pills-repair" role="tab" aria-controls="v-pills-repair" aria-selected="false">Repairs</a>
			...
			<div class="tab-content" id="v-pills-tabContent">
			  <div class="tab-pane fade show active" id="v-pills-item" role="tabpanel" aria-labelledby="v-pills-item-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Item Part Details</div>
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-3">
						  ...
						  <input type="text" class="form-control datepicker" id="purchaseDetailsPurchaseDate" name="purchaseDetailsPurchaseDate" readonly value="2020-01-01">
						</div>
						<div class="form-group col-md-2">
					 ...
					 <form> 
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
							...
							<select id="vendorDetailsStatus" name="vendorDetailsStatus" class="form-control chosenSelect">
								<?php include('inc/statPerson.html'); ?>
							</select>
						</div>
						 <div class="form-group col-md-3">
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-3">
							...
							<input type="text" class="form-control invTooltip" id="vendorDetailsVendorMobile" name="vendorDetailsVendorMobile" title="Please enter numbers leading +63">
						  </div>
						  <div class="form-group col-md-3">
							<label for="vendorDetailsVendorPhone2">Phone (telephone)</label>
					 ...
					 <form> 
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-3">
							...
							<input type="text" class="form-control invTooltip" id="customerDetailsCustomerMobile" name="customerDetailsCustomerMobile" title="Please enter numbers leading +63">
						  </div>
						  <div class="form-group col-md-3">
							<label for="customerDetailsCustomerPhone2">Phone (telephone)</label>
			  ...
			  <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Search GUTZ<button id="searchTablesRefresh" name="searchTablesRefresh" class="btn btn-warning float-right btn-sm">Refresh</button></div>
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemReportsTab">Item Parts</a>
						</li>
						<li class="nav-item">
			   ...
			   <div class="tab-pane fade" id="v-pills-repair" role="tabpanel" aria-labelledby="v-pills-repair-tab">
			  	<div class="card card-outline-secondary my-4">
			  	  ...
			  	  <div class="card-body">
			  	  	<ul class="nav nav-tabs" role="tablist">
						<li class="nav-repair">
							<a class="nav-link active" data-toggle="tab" href="#repairDetailsTab">Repairs</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#repairImageTab">Upload Order Slip</a>
						</li>
					</ul>

					<!-- Tab panes for repair details and image sections -->
	        		<div class="tab-content">
	        		<div id="repairDetailsTab" class="container-fluid tab-pane active">
	        			<br>
	        			<!-- Div to show the ajax message from validations/db submission -->
						<div id="repairDetailsMessage"></div>
						<form>
							<div class="form-row">
		          				<div class="form-group col-md-2" style="display:inline-block">
		               				<label for="orderDetailsOrderNumber">Order No.<span class="requiredIcon">*</span></label>
		               				<input type="text" class="form-control" name="orderDetailsOrderNumber" id="orderDetailsOrderNumber" autocomplete="off">
		               				<div id="orderDetailsOderNumberSuggestionsDiv" class="customListDivWidth"></div>
		          				</div>
		          				<div class="form-group col-md-2">
		               				<label for="repairDetailsRepairID">Repair ID</label>
		               				<input class="form-control invTooltip" type="number" readonly  id="repairDetailsRepairID" name="repairDetailsRepairID" title="This will be auto-generated when you add a new repair order">
		          				</div>
		          				<div class="form-group col-md-2">
									<label for="repairDetailsCustomerID">Customer ID<span class="requiredIcon">*</span></label>
									<input type="text" class="form-control" id="repairDetailsCustomerID" name="repairDetailsCustomerID" autocomplete="off">
									<div id="repairDetailsCustomerIDSuggestionsDiv" class="customListDivWidth"></div>
								</div>
		          				<div class="form-group col-md-4">
									<label for="repairDetailsCustomerName">Customer Name</label>
									<input type="text" class="form-control" id="repairDetailsCustomerName" name=" repairDetaisCustomerName" readonly>
		          				</div>
	    	    			</div>
	    	    			<div class="form-row">
	    	    				<div class="form-group col-md-2">
									<label for="repairDetailsDateIssued">Date Issued<span class="requiredIcon">*</span></label>
									<input type="text" class="form-control datepicker" id="repairDetailsDateIssued" name="repairDetailsDateIssued" readonly value="2020-01-01">
		          				</div>
		          				<div class="form-group col-md-2">
		          					<label for="repairDetailsDateRepaired">Date Repaired<span>*</span></label>
		          					<input type="text" class="form-control datepicker" id="repairDetailsDateRepaired" name="repairDetailsDateRepaired" readonly value="Update if repaired">
		          					
		          				</div>
		          				<div class="form-group col-md-2">
									<label for="repairDetailsStatus">Status</label>
									<select id="repairDetailsStatus" name="repairDetailsStatus" class="form-control chosenSelect">
										<?php include('inc/repairStatus.html'); ?>
									</select>
								  </div>
	    	    			</div>
	    	    			<div class="form-row">
	    	    				<div class="form-group col-md-1">
	    	    					<label for="repairDetailsQuantity">Quantity<span class="requiredIcon">*</span></label>
									<input type="number" class="form-control" id="repairDetailsQuantity" name="repairDetailsQuantity" value="1">
	    	    				</div>
	    	    				<div class="form-group col-md-5">
	    	    					<label for="repairDetailsRepairItem">Repair Item<span class="requiredIcon">*</span></label>
									<input type="text" class="form-control" name="repairDetailsRepairItem" autocomplete="off">
									<div id="repairDetailsRepairItemSuggestionDiv" class="customListDivWidth"></div>
	    	    				</div>
	    	    				<div class="form-group col-md-2">
	    	    					<label for="repairDetailsCategory">Category</label>
									<select id="repairDetailsCategory" name="repairDetailsCategory" class="form-control chosenSelect">
	    	    			...
	    	    			<div class="form-row">
	    	    				<div class="form-group col-md-6" style="display:inline-block">
									<!-- <label for="repairDetailsProblem">Problem/Diagnosis</label> -->
									<textarea rows="4" class="form-control" placeholder="Indicate the State of the item" name="repairDetailsProblem" id="repairDetailsProblem"></textarea>
		           				</div>
		           				<div class="form-group col-md-6" style="display:inline-block">
									<!-- <label for="repairDetailsAccessories">Accessories</label> -->
									<textarea rows="4" class="form-control" placeholder="List of Accessories comes with the item" name="repairDetailsAccessories" id="repairDetailsAccessories"></textarea>
		          				</div>
		          				<div class="form-group col-md-3">
									<div id="imageContainer"></div>
		          				</div>
						...
						<div id="repairImageTab" class="container-fluid tab-pane fade">
						<br>
							<div id="repairImageMessage"></div>
							<p>You can upload the image of the item to be repaired or the order slip for  this section.</p> 
							<p>Please make sure the repair order is already added to database before uploading the image.</p>
							<br>
							<form name="imageForm" id="imageForm" method="post">
								<div class="form-group col-md-3" style="display:inline-block">
									<label for="repairImageOrderNo">Order No<span class="requiredIcon">*</span></label>
			        				<input type="text" class="form-control" name="repairImageOrderNo" id="repairImageOrderNor" autocomplete="off">
			        				<div id="repairImageOrderNoSuggestionsDiv" class="customListDivWidth"></div>
								</div>
								<div class="form-group col-md-4">
									<label for="repairImageOrderNo">Item Repair</label>
			        				<input type="text" class="form-control" name="repairImageOrderNo" id="repairImageOrderNo" readonly>
								</div>
								<br>
								<div class="form-row">
									<div class="form-group col-md-7">
										<label for="repairImageFile">Select Image ( <span class="blueText">jpg</span>, <span class="blueText">jpeg</span>, <span class="blueText">gif</span>, <span class="blueText">png</span> only )</label>
			        					<input type="file" class="form-control-file btn btn-dark" id="repairImageFile" name="repairImageFile">	
									</div>	
								</div>
								<br>
								<button type="button" id="updateImageButton" class="btn btn-primary">Upload Image</button>
