...
INSERT INTO `repair` (`repairID`, `orderNo`, `customerID`, `customerName`, `repairItem`, `serialNo`, `quantity` ,`dateIssued`, `dateRepaired`, `status`, `accessories`, `problem`, `imageURL`) VALUES
...
--
ALTER TABLE `customer`
  MODIFY `repairID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
